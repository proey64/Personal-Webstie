...
const SMarquees = () => (
  <Div>
    ...
    company in West Sussex, erecting marquees for weddings etc.
    <br />
    ...
    javascript and reminding myself of the HTML and css I had used previously.
  </Div>
);

export default SMarquees;
